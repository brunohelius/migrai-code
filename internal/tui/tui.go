...
import (
	...
	"github.com/brunohelius/migrai-code/internal/app"
	...
	"github.com/brunohelius/migrai-code/internal/tui/components/core"
	"github.com/brunohelius/migrai-code/internal/tui/components/dialog"
	"github.com/brunohelius/migrai-code/internal/tui/layout"
	"github.com/brunohelius/migrai-code/internal/tui/page"
...
func New(app *app.App) tea.Model {
	...
	model.RegisterCommand(dialog.Command{
		...
		Handler: func(cmd dialog.Command) tea.Cmd {
			prompt := `Please analyze this codebase and create a migrai-code.md file containing:
1. Build/lint/test commands - especially for running a single test
2. Code style guidelines including imports, formatting, types, naming conventions, error handling, etc.

The file you create will be given to agentic coding agents (such as yourself) that operate in this repository. Make it about 20 lines long.
If there's already a migrai-code.md, improve it.
