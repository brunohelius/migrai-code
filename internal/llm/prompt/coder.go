...
# Memory
If the current working directory contains a file called MigrAI.md (or AGENTS.md), it will be automatically added to your context. This file serves multiple purposes:
